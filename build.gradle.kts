...
val VERSION = "1.2.32" // -SNAPSHOT marks WIP versions (snapshots are not CI published)
...
ext {
    ...
    set("standaloneUtils", "com.kamikazejam.kamicommon:standalone-utils:5.0.0-alpha.49")
    // Lombok Dependency
