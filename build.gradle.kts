...
val VERSION = "1.2.30" // -SNAPSHOT marks WIP versions (snapshots are not CI published)
...
ext {
    ...
    set("standaloneUtils", "com.kamikazejam.kamicommon:standalone-utils:5.0.0-alpha.48")
    // Lombok Dependency
