...
/**
 * {@code v1_11_R1}'s text implementation, reached through {@code TextBundles} from the child
 * classloader. Lives in the nested jar because everything it delegates to names the relocated
 * Adventure.
 */
public final class TextBundleImpl_v1_11_R1 implements TextBundle {
    ...
    public @NotNull VersionedComponent fromJson(@NotNull String json) {
        return new VersionedComponent_1_11_R1(JSONComponentSerializer.json().deserialize(json));
    }
