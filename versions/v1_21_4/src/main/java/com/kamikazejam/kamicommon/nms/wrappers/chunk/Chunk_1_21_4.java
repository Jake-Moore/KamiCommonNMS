...
public class Chunk_1_21_4 implements NMSChunkDef {
    private final @NotNull ChunkProvider_1_21_4 provider;
    private final @NotNull Chunk bukkitChunk;
    private final @NotNull ChunkAccess chunk;
    public Chunk_1_21_4(@NotNull ChunkProvider_1_21_4 provider, @NotNull Chunk bukkitChunk) {
    ...
    public @NotNull NMSChunkSection getSection(int y) {
        return new ChunkSection_1_21_4(this, this.chunk, y);
    }
