...
import com.kamikazejam.kamicommon.nms.event.PreSpawnSpawnerAdapter_1_13_R1;
import com.kamikazejam.kamicommon.nms.item.ItemEditor_1_13_R1;
...
public class NmsBundleImpl implements NmsBundle {
    ...
    public @NotNull AbstractItemEditor itemEditor() {
        return new ItemEditor_1_13_R1();
    }

    @Override
    public @NotNull Listener preSpawnSpawnerAdapter() {
        return new PreSpawnSpawnerAdapter_1_13_R1();
    }
}
