...
import com.kamikazejam.kamicommon.nms.wrappers.packet.impl.OutEntityDestroy_1_21_CB;
import com.kamikazejam.kamicommon.nms.wrappers.packet.impl.OutEntityStatus_1_21_CB;
...
public class NMSPacketHandler_1_21_CB implements NMSPacketHandler {

    @Override
    public @NotNull NMSPacket wrapPacket(@NotNull Object packet) {
        if (packet instanceof ClientboundEntityEventPacket) {
            return new OutEntityStatus_1_21_CB((ClientboundEntityEventPacket) packet);
        }
    ...
    public @NotNull NMSOutEntityDestroy createDestroyPacket(final int... ids) {
        return new OutEntityDestroy_1_21_CB(new ClientboundRemoveEntitiesPacket(ids));
    }
