...
import com.kamikazejam.kamicommon.nms.block.BlockUtil1_16_R2;
import com.kamikazejam.kamicommon.nms.bundle.NmsBundle;
import com.kamikazejam.kamicommon.nms.chatcolor.ChatColor_1_16_R2;
import com.kamikazejam.kamicommon.nms.entity.EntityMethods_1_16_R2;
import com.kamikazejam.kamicommon.nms.item.NmsItemMethods_1_16_R2;
import com.kamikazejam.kamicommon.nms.itemtext.ItemText_1_16_R2;
...
import com.kamikazejam.kamicommon.nms.wrappers.packet.NMSPacketHandler_1_16_R2;
...
/**
 * The {@code v1_16_R2} module's implementation of {@link NmsBundle}.
 * <p>
...
public class NmsBundleImpl implements NmsBundle {
    ...
    public @NotNull NMSWorld nmsWorld(@NotNull World world, @NotNull Provider<AbstractBlockUtil> blockUtil) {
        return new NMSWorld_1_16_R2(world, blockUtil);
    }
