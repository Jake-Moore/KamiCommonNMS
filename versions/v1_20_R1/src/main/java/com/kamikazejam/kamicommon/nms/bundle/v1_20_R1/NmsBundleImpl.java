package com.kamikazejam.kamicommon.nms.bundle.v1_20_R1;
...
import com.kamikazejam.kamicommon.nms.block.BlockUtil1_20_R1;
import com.kamikazejam.kamicommon.nms.bundle.NmsBundle;
import com.kamikazejam.kamicommon.nms.entity.EntityMethods_1_20_R1;
import com.kamikazejam.kamicommon.nms.item.NmsItemMethods_1_20_R1;
...
import com.kamikazejam.kamicommon.nms.wrappers.packet.NMSPacketHandler_1_20_R1;
...
/**
 * The {@code v1_20_R1} module's implementation of {@link NmsBundle}.
 * <p>
...
public class NmsBundleImpl implements NmsBundle {
    ...
    public @NotNull NMSWorld nmsWorld(@NotNull World world, @NotNull Provider<AbstractBlockUtil> blockUtil) {
        return new NMSWorld_1_20_R1(world, blockUtil);
    }
