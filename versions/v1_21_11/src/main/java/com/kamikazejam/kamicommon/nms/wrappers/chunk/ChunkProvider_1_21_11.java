...
public class ChunkProvider_1_21_11 implements NMSChunkProvider {
    private final @NotNull NMSWorld_1_21_11 world;
    private final @NotNull ServerChunkCache handle;
    public ChunkProvider_1_21_11(@NotNull NMSWorld_1_21_11 world, @NotNull ServerChunkCache server) {
        this.world = world;
        this.handle = server;
    }
    ...
    public @NotNull NMSChunk wrap(org.bukkit.@NotNull Chunk chunk) {
        return new Chunk_1_21_11(this, chunk);
    }
}
