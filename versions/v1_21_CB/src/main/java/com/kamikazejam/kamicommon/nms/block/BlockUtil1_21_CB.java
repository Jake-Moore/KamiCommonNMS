...
import static com.kamikazejam.kamicommon.nms.wrappers.chunk.ChunkSection_1_21_CB.SET_BLOCK_STATE_FLAG;
...
public class BlockUtil1_21_CB extends IBlockUtil1_13<BlockState> {
    ...
    public void setNMS(@NotNull Block b, @NotNull BlockState ibd) {
        ...
        try {
            // see ChunkSection_1_21_CB for details on the 512 bitmask flag
