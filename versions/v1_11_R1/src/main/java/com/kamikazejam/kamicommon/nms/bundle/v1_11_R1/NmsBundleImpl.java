...
import com.kamikazejam.kamicommon.nms.block.BlockUtil1_11_R1;
import com.kamikazejam.kamicommon.nms.bundle.NmsBundle;
import com.kamikazejam.kamicommon.nms.entity.EntityMethods_1_11_R1;
import com.kamikazejam.kamicommon.nms.item.ItemEditor_1_11_R1;
import com.kamikazejam.kamicommon.nms.item.NmsItemMethods_1_11_R1;
import com.kamikazejam.kamicommon.nms.itemtext.ItemText_1_11_R1;
...
import com.kamikazejam.kamicommon.nms.wrappers.packet.NMSPacketHandler_1_11_R1;
...
/**
 * The {@code v1_11_R1} module's implementation of {@link NmsBundle}.
 * <p>
...
public class NmsBundleImpl implements NmsBundle {
    ...
    public @NotNull NMSWorld nmsWorld(@NotNull World world, @NotNull Provider<AbstractBlockUtil> blockUtil) {
        return new NMSWorld_1_11_R1(world, blockUtil);
    }
    ...
    public @NotNull VersionedComponent componentFromJson(@NotNull String json) {
        return TextBundles.forModule("v1_11_R1").fromJson(json);
    }

    @Override
    public @NotNull VersionedComponent componentFromPlainText(@NotNull String text) {
        return TextBundles.forModule("v1_11_R1").fromPlainText(text);
    }

    @Override
    public @NotNull VersionedComponent componentFromMiniMessage(@NotNull String miniMessage) {
        return TextBundles.forModule("v1_11_R1").fromMiniMessage(miniMessage);
    }
