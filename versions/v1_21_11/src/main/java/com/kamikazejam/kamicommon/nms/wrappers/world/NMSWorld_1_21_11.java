...
import com.kamikazejam.kamicommon.nms.wrappers.chunk.ChunkProvider_1_21_11;
 ...
 */
public class NMSWorld_1_21_11 implements NMSWorld {
    @Getter
    ...
    public NMSWorld_1_21_11(@NotNull World world, @NotNull Provider<AbstractBlockUtil> provider) {
    ...
    public @NotNull NMSChunkProvider getChunkProvider() {
        return new ChunkProvider_1_21_11(this, this.serverLevel.getChunkSource());
    }
